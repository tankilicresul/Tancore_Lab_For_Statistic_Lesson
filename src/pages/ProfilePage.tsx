          ...
          <div className="mt-4 pt-4 border-t border-white/10 space-y-3.5 relative z-10">
            ...
            <div className="flex items-center justify-between gap-2 pt-2 border-t border-white/10">
              <button
                ...
                className="flex items-center space-x-1.5 px-3.5 py-1.5 rounded-xl bg-white/10 hover:bg-white/20 text-xs font-bold transition-colors border border-white/15 shrink-0 whitespace-nowrap cursor-pointer text-slate-200 hover:text-white"
              >
