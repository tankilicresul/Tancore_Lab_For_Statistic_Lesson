          ...
          <div className="bg-slate-950 rounded-2xl p-4 sm:p-6 text-white shadow-xl relative overflow-hidden border border-slate-800">
            ...
            <div className="flex items-start space-x-3.5 relative z-10 pr-8">
              ...
              <div className="relative shrink-0">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-gradient-to-br from-slate-800 to-slate-900 border-2 border-[#ff7a00]/60 flex items-center justify-center text-3xl sm:text-4xl shadow-lg">
                  {profile.avatarEmoji || '👦'}
                </div>
                <div
